...
# presumably for release of new code. 
     ...
     chmod -R 775 /$INGMENV/server/scripts
...
presentation_unprotect()
{
    ...
    echo "DEVBASE is ... $DEVBASE"
    echo "INGMENV is ... $INGMENV"
    echo "name is ...... " `whoami`
...
# 
     ...
     chmod    750 /$INGMENV/presentation/logs
     chmod -R 750 /$INGMENV/presentation/menuserver
     chmod -R 775 /$INGMENV/presentation/processdefs
     chmod -R 775 /$INGMENV/presentation/scripts
     chmod -R 775 /$INGMENV/presentation/webpages
     chmod    750 /$INGMENV/presentation/work
 
#
# Only certain sub directories of Webserver can be protected. 
#
     chmod    750 /$INGMENV/presentation/webserver
     chmod -R 775 /$INGMENV/presentation/webserver/english
     chmod -R 775 /$INGMENV/presentation/webserver/japanese
     chmod -R 775 /$INGMENV/presentation/webserver/images
     chmod -R 775 /$INGMENV/presentation/webserver/js
