...
# INCLUDE "GenUpdate.f";
# INCLUDE "BFUpdateAudEdt.f";
INCLUDE "BF9G99-P.p";
# 23774A CHANGES END

PROCESS BF0682Update
{
#* 23774A CHANGES START
#    STEP Main
#    {
#           USES PROCESS "GenUpdate";
#           USES PROCESS "BFUpdateAudEdt";
#
#       ATTRIBUTES
#       {
#           GetMessages = "NO";
#       }
#
#       STRINGTABLE.IDS_TITLE_BF0682Update -> Title;
#       "BF0680-I" -> InputS;
#       "BF0680-P" -> RetrieveP;
#       "BF0682-I" -> EditS;
#       "BF0682-P" -> UpdateP;
...
#   BRANCH Main;
    ...
    Title = STRINGTABLE.IDS_TITLE_BF0682Update;     
    TitleBar = "TitleBar";
    TitleBarSize = "70";
