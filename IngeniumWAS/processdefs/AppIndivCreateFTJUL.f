...
#*******************************************************************************
#*  Component:   AppIndivCreateFTJUL.f                                         *
#*  Description:                                                               *
#*                                                                             *
#*******************************************************************************
...
#*  B00598  VAN      CASE SENSITIVE FOR UNIX                                   * 
#*  PF30    PF 3.0   Corrected VARIABLES braces {} after converion             *
#*                                                                             *
#*******************************************************************************

INCLUDE "AppIndivCreateFTJUL.s";
INCLUDE "BF1221-P.p";
...
PROCESS AppIndivCreateFTJUL
{
  ...
  VARIABLES
  {
    ...
    MIR-CLI-ENTR-GIV-NM-T[2] = Search-first-name;
    MIR-CLI-MID-INIT-NM-T[2] = Search-mid-init;
    MIR-CLI-ENTR-SUR-NM-T[2] = Search-last-name;
    MIR-CLI-PSTL-CD-T[1] = Search-pstl-cd;
    ...
    MIR-CLI-ADDR-MUN-CD = "";
    MIR-CLI-ADDR-STAT-CD-T[1] = "";
    MIR-CLI-BTH-LOC-CD = "";
    MIR-CLI-CLAS-CD = "";
    MIR-CLI-CLAS-CTRY-CD = "";
    MIR-CLI-LANG-CD = "";
    MIR-CLI-MAIL-TITL-TXT = "";
    MIR-CLI-MARIT-STAT-CD = "";
    MIR-CLI-OCCP-CLAS-CD = "";
    MIR-OCCP-ID = "";
    MIR-CLI-SFX-NM = "";
    MIR-CLI-SMKR-CD = "";
    MIR-AGT-ID = "";
    MIR-BEST-TIME-CALL-TXT = "";
    MIR-CLI-ADDR-LOC-CD = "";
    MIR-CLI-ADDR-YR-DUR = "";
    MIR-CLI-CO-NM-T[1] = "";
    MIR-CLI-COMNT-TXT = "";
    MIR-CLI-ENTR-CO-NM-T[1] = "";
    MIR-CLI-ENTR-CO-NM-T[2] = "";
    MIR-CLI-GIV-NM-T[1] = "";
    MIR-CLI-PREV-EMPLR-NM-T[1] = "";
    MIR-CLI-PREV-EMPLR-NM-T[2] = "";
    MIR-CLI-STMT-DT = "";
    MIR-CLI-SUR-NM-T[1] = "";
    MIR-DV-AGT-NM = "";
    MIR-DV-UPDT-ADDR-IND = "";
    MIR-DV-UPDT-NM-IND = "";
    MIR-PREV-EMPL-YR-DUR = "";
    MIR-CLI-ADDR-CNTCT-TXT = "";
    MIR-CLI-ADDR-ADDL-TXT-T[1] = "";
    MIR-CLI-NM-CHNG-DT = "";
    MIR-CLI-PREFCT-TXT = "";
    MIR-CLI-KA-PREFCT-TXT = "";
    MIR-CLI-KA-CITY-TXT = "";
    MIR-CLI-KA-NGHBRHD-TXT = "";
    MIR-CLI-ADDR-CHNG-DT-T[1] = "";
    MIR-ADDR-STAT-CHNG-DT-T[1] = "";
    MIR-CLI-PREV-ADDR-LOC-CD-T[1] = "";
    MIR-CLI-PREV-CRNT-LOC-CD-T[1] = "";
    MIR-CLI-PREV-PSTL-CD-T[1] = "";
    MIR-CLI-PREV-CTRY-CD-T[1] = "";
    MIR-CLI-PREV-KA-NGHBRHD-TXT-T[1] = "";
    MIR-CLI-PREV-PREFCT-TXT-T[1] = "";
    MIR-CLI-PREV-KA-PREFCT-TXT-T[1] = "";
    MIR-CLI-PREV-CITY-NM-TXT-T[1] = "";
    MIR-CLI-PREV-KA-CITY-TXT-T[1] = "";
    MIR-CLI-PREV-ADDR-LN-1-TXT-T[1] = "";
    MIR-CLI-PREV-ADDR-ADDL-TXT-T[1] = "";
    MIR-CLI-PREV-CNTCT-TXT-T[1] = "";
    MIR-CLI-PREV-ADDR-YR-DUR-T[1] = "";
    ...
    {
        USES S-STEP "AppIndivCreateFTJUL";
        CreateTitle -> Title;
    }
    ...
    IF action == "ACTION_OK"
    {
        ...
        # if either codes are 03, then return to the indiv. page with line 1 
