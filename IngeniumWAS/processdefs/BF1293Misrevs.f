...
PROCESS BF1293Misrevs
{
    STEP Main
    {
        ...
        STRINGTABLE.IDS_TITLE_BF1293Process -> ProcessTitle;
        STRINGTABLE.IDS_TITLE_BF1293Phase1 -> Phase1Title;
        STRINGTABLE.IDS_TITLE_BF1293Phase2 -> Phase2Title;
        STRINGTABLE.IDS_TITLE_BF1293Phase3 -> Phase3Title;
        ...
        "BF1293-P" -> GetInitialHostDataP;
        "BF1293-I" -> DataInputS;
        "BF1293-P" -> PerformHostEditsP;
        "BF1293-O" -> ConfirmS;
        "BF1293-P" -> UpdateHostP;
