...
INCLUDE "BF0614-O.s";
INCLUDE "BF0614-P.p";
INCLUDE "BF0610Retrieve.f";
INCLUDE "BF0611Create.f";
INCLUDE "BF0612Update.f";
INCLUDE "BF0613Delete.f";

PROCESS BF0614List
{
    Title = STRINGTABLE.IDS_TITLE_BF0614List;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
...
#UY3004 CHANGES END	
    ...
    MIR-CVG-ENHC-DT = MIR-CVG-ENHC-DT-T[index];
    ...
    IF action == "SelectItem" || action == "ACTION_INQUIRE"
    {
        STEP SelectItem
        {
            ...
            MIR-CVG-ENHC-DT -> MIR-CVG-ENHC-DT;
