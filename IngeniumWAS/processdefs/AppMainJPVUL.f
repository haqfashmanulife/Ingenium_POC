...
INCLUDE "AppApplicationDataJPVUL.s";
...
INCLUDE "AppPolicyDataVUL.s";
INCLUDE "BF8000-P.p";
INCLUDE "BF8024-P.p";
INCLUDE "AppBF8025-P.p";
INCLUDE "BF8004-P.p";
INCLUDE "AppAllocationsVUL.f";
INCLUDE "AppBillingJPVUL.s";
INCLUDE "AppInsuredJP.f";
INCLUDE "BF0591-P.p";
INCLUDE "AppAnalysisVUL.s";
INCLUDE "AppAgentSearch.f";
INCLUDE "AppSignatures.s";
INCLUDE "AppBene.f";
INCLUDE "AppCwaJPVUL.f";

PROCESS AppMainJPVUL
{
    ...
    {
        USES S-STEP "AppApplicationDataJPVUL";
    ...
    STEP Allocations
    {
        USES PROCESS "AppAllocationsVUL";
    }
    ...
    # if for any reason, AR records could not be created, sub-flow
    # will return a blank value for the next variable.  Send user on to
    # Beneficiary data.  Correction for misentered data will have to be
    # made out of flow, or re-tried via Previous button on Bene page.
    # Note:  this variable will also be blank if no DCA instructions
