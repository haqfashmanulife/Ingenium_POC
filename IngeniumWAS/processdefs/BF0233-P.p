...
P-STEP BF0233-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "0233";
        BusinessFunctionName = "Cheque Reconciliation Cancel";
        BusinessFunctionType = "Cancel";
        MirName = "CCWM0175";
    }
    ...
    INOUT MIR-CHQ-PD-OR-CNCL-DT
    {
        ...
        DBTableName = "TCR";
        SType = "Date";
        Label = "Date Cheque was Cancelled";
    }
