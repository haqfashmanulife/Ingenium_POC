...
#*  ABU205  CTS      AFTER 'FINAL APPROVAL' THE CONTROL GOES TO KEY INPUT      *
#*                   SCREEN AND MESSAGE WILL BE DISPLAYED                      *
...
PROCESS BF9A32Approve
{
    Title = STRINGTABLE.IDS_TITLE_BF9A32Approve;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
