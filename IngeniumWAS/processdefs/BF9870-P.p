...
#*******************************************************************************
#*  Component:   BF9870-P.p                                                    *
#*  Description: Disease/Surgery Major Code Retrieve                           *
#*                                                                             *
#*******************************************************************************
...
P-STEP BF9870-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "9870";
        BusinessFunctionName = "Major Code Retrieve";
    ...
    OUT MIR-T3-BENM-MULTR-FCT-T[20]
    {
        Length = "5";
        FieldGroup = "Table3";
        DBTableName = "TBENM";
