...
P-STEP BF5102-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "5102";
        BusinessFunctionName = "Bank Billing History Policy Update";
    ...
    INOUT MIR-PAC-DRWD-LOAN-AMT-T[100]
    {
        Length = "13";
        FieldGroup = "Table100";
        DBTableName = "TPDRD";
    ...
    INOUT MIR-PAC-DRWD-MPREM-AMT-T[100]
    {
        Length = "13";
        FieldGroup = "Table100";
        DBTableName = "TPDRD";
    ...
    INOUT MIR-PAC-DRWD-REDRW-IND-T[100]
    {
        Length = "1";
        FieldGroup = "Table100";
        DBTableName = "TPDRD";
    ...
    INOUT MIR-PAC-DRWD-SNDRY-AMT-T[100]
    {
        Length = "13";
        FieldGroup = "Table100";
        DBTableName = "TPDRD";
    ...
    INOUT MIR-PAC-DRWD-SUSP-AMT-T[100]
    {
        Signed;
        Length = "13";
        FieldGroup = "Table100";
