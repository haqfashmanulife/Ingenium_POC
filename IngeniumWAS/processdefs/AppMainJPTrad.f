...
INCLUDE "AppApplicationDataJPTrad.s";
...
INCLUDE "AppPolicyDataTrad.s";
INCLUDE "BF8000-P.p";
INCLUDE "BF8024-P.p";
INCLUDE "AppBF8025-P.p";
INCLUDE "BF8004-P.p";
INCLUDE "AppBillingJPTrad.s";
INCLUDE "AppInsuredJP.f";
INCLUDE "BF0591-P.p";
INCLUDE "AppAnalysisTrad.s";
INCLUDE "AppAgentSearch.f";
INCLUDE "AppSignatures.s";
INCLUDE "AppBene.f";
INCLUDE "AppCwaJPTrad.f";

PROCESS AppMainJPTrad
{
    ...
    {
        USES S-STEP "AppApplicationDataJPTrad";
