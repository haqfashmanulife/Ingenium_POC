...
INCLUDE "BF1191Create.f";
INCLUDE "BF1192Update.f";
INCLUDE "BF1193Delete.f";

PROCESS BF1194List
{
    Title = STRINGTABLE.IDS_TITLE_BF1194List;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
    ...
    MIR-CPREQ-SEQ-NUM = MIR-CPREQ-SEQ-NUM-T[index];
