...
#*  TLB003   CTS      NEW BUSINESS CHANGES FOR TLB                             *
#*  26878B   CTS      CHANGES DONE FOR ADDITION OF NEW FIELDS                 *
...
#    OUT MIR-DEL-IND-T[20]  
    OUT MIR-DEL-IND-T[30]
    {
        Length = "01";
        SType = "Indicator";
        DBTableName = "TLNCC";
...
#    OUT MIR-ORD-DB-AMT-T[20] 
    OUT MIR-ORD-DB-AMT-T[30] 
    {
        Label = "Death face amountt";
        Length = "17";
        DBTableName = "TLNCC";
        SType = "Currency";
        Index ="1";
    }
#    OUT MIR-ACC-DB-AMT-T[20]  
    OUT MIR-ACC-DB-AMT-T[30]
    {
...
#    OUT MIR-MEDIC-BNFT-DLY-AMT-T[20]
    OUT MIR-MEDIC-BNFT-DLY-AMT-T[30]  
    {
...
#    OUT MIR-ACC-BNFT-DLY-AMT-T[20]
    OUT MIR-ACC-BNFT-DLY-AMT-T[30]
    {
...
#    OUT MIR-POL-OWN-CLI-NM-T[20]
    OUT MIR-POL-OWN-CLI-NM-T[30]
    {
        Length = "75";
        SType = "Text";
        DBTableName = "TLNCC";
...
#    OUT MIR-INSRD-CLI-ADDR-T[20]
    OUT MIR-INSRD-CLI-ADDR-T[30]
    {
        Length = "50";
        SType = "Text";
        DBTableName = "TLNCC";
...
#    OUT MIR-LINC-ISSUE-DT-T [20]
    OUT MIR-LINC-ISSUE-DT-T [30]
    {
        Length = "10";
        DBTableName = "TLNCC";
        SType = "Date";
...
#    OUT MIR-LINC-APP-REG-DT-T [20]
    OUT MIR-LINC-APP-REG-DT-T [30]
    {
        Length = "40";
        DBTableName = "TLNCC";
        SType = "Date";
...
#    OUT MIR-LINC-COM-USE-T [20]
    OUT MIR-LINC-COM-USE-T [30]
...
#27676A CHANGES START HERE
    ...
    OUT MIR-FDIS-HOSP-BNFT-AMT-T[30]
    {
    ...
    OUT MIR-OTHR-HOSP-BNFT-AMT-T[30]
    {
...
#27676A CHANGES START HERE
    ...
    OUT MIR-TOT-FDIS-HOSP-BNFT-AMT
    {
    ...
    OUT MIR-TOT-OTHR-HOSP-BNFT-AMT
    {
...
#    OUT MIR-UW-DECISN-CD-T[5]
    OUT MIR-UW-DECISN-CD-T[30]
    {
        Length = "01";
        CodeSource = "EDIT";
        CodeType = "UWDCD";
...
#    OUT MIR-UW-COMNTS-T[5]
    OUT MIR-UW-COMNTS-T[30]
    {
        Length = "200";
        DBTableName = "TUWFD";
        SType = "Text";
...
#UY403B CHANGES START HERE
    ...
    OUT MIR-MANL-POL-OWN-CLI-NM-T[30]
    {
        Length = "75";
        SType = "Text";
        DBTableName = "TLNCC";
    ...
    OUT MIR-MANL-JDGMNT-S-AMT-T[30]
    {
        Label = "Judgment S";
        Length = "17";
        SType = "Currency";
    ...
    OUT MIR-MANL-CNTNU-CNSDR-CD-T[30]
    {
        Length = "1";
        CodeSource = "DataModel";
    ...
    OUT MIR-MANL-TOT-BNFT-AMT
    {
        Label = "Total Benefit Amount";
        Length = "17";
        SType = "Currency";
    }
    OUT MIR-MANL-TOT-JDGMNT-S-AMT
    {
        Label = "Total Judgment S";
        Length = "17";
        SType = "Currency";
    }    
    OUT MIR-MANL-ANN-SALE-AMT
    {
        Label = "Annual Sales";
        DBTableName = "TLNCC";
#TLB003 CHANGES START HERE
...
#TLB003 CHANGES END HERE
    ...
    OUT MIR-MANL-CNVR-ANN-SALE-AMT
    {
...
#TLB003 CHANGES END HERE
    ...
    OUT MIR-MANL-UW-JDGMNT-CD
    {
        Label = "Underwriting Judgment Of Annual Sales";
        Length = "2";
        SType = "Text";
    }
    OUT MIR-MANL-MIN-ANN-SALE-AMT
    {
...
#TLB003 CHANGES ENDS HERE
    ...
    OUT MIR-MANL-ANN-INCM-FCT
    {
        Label = "Annual Income Ratio";
        Length = "02";
        SType = "Text";
    }
    OUT MIR-MANL-CNVR-ANN-INCM-AMT
    {
...
#TLB003 CHANGES ENDS HERE
    ...
    OUT MIR-MANL-UW-JDGMNT-INCM-CD
    {
        Label = "Underwriting Judgment Of Annual Income";
        Length = "2";
        SType = "Text";
    }
    OUT MIR-MANL-MIN-ANN-INCM-AMT
    {
...
#TLB003 CHANGES ENDS HERE
    ...
    OUT MIR-MANL-SAVE-INS-TYP-CD-T[30]
    {
        DBTableName = "TLNCC";
        SType = "Hidden";
        Index = "1";
    }
    OUT MIR-MANL-SAVE-COEFF-FCT-T[30]
    {
        DBTableName = "TLNCC";
        SType = "Hidden";
        Index = "1";
    }
    OUT MIR-SAVE-MANL-CO-ID-T[30]
    {
        DBTableName = "TLNCC";
        SType = "Hidden";
        Index = "1";
