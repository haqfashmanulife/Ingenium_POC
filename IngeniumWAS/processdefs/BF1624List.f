...
PROCESS BF1624List
{
    Title = STRINGTABLE.IDS_TITLE_BF1624List;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
    ...
    # If coming from the Plan Bonus Declaration Search,
    ...
    Title = STRINGTABLE.IDS_TITLE_BF1624List;
    ButtonBar = "ButtonBarListsCRUDDate";

    STEP DisplayList
    {
        USES S-STEP "BF1624-O";
    }
