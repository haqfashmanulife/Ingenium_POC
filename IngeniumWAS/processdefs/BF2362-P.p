...
P-STEP BF2362-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "2362";
        BusinessFunctionName = "Requirements Update";
...
#BU1581 CHANGES END    
    ...
    INOUT MIR-DV-INSRD-CLI-NM-T[40]
    {
        MixedCase;
        Length = "75";
        FieldGroup = "Table40";
    ...
    INOUT MIR-DV-CLI-UWG-REQIR-IND-T[40]
    {
        Length = "1";
        FieldGroup = "Table40";
        DBTableName = "Derived";
