...
S-STEP DisSearch-O
{
	...
	INOUT MIR-LANG-DESC-1-TXT 
	{
		...
		Length = "60";
		SType = "Text";
		Label = "Disease Minor Code Katakana Descriptions:";
	}
...
#143C45 CHANGES STARTS HERE
	...
	INOUT MIR-LANG-DESC-2-TXT 
	{
		...
		Length = "60";
		SType = "Text";
		Label = "Disease Minor Code Kanji Descriptions:";
	}
#143C45 CHANGES ENDS HERE 	
	IN MIR-GRP-MEDC-ID-T[100] 
	{
		DisplayOnly;
		Length = "10";
		FieldGroup = "Table1";
	...
	IN MIR-GRP-LANG-DESC-1-TXT-T[100] 
	{
		DisplayOnly;
		Length = "60";
		FieldGroup = "Table1";
