...
P-STEP BF0930-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "0930";
        BusinessFunctionName = "Annuity Destination Details Retrieve";
    ...
    OUT MIR-CDAD-ROLOVR-INT-RT-T[10]
    {
        Length = "7";
        Decimals = "4";
        FieldGroup = "Table10";
