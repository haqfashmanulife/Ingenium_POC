...
#*******************************************************************************
#*  Component:   AppIndivSearchFTJULU.f                                        *
#*  Description:                                                               *
#*                                                                             *
#*******************************************************************************
...
PROCESS AppIndivSearchFTJULU
{
  ...
  VARIABLES
  {
    ...
    TitleBar = "TitleBar";
    TitleBarSize = "70";
    ButtonBar = "AppButtonBarSearchPrevNext";
    ButtonBarSize = "40";
    ...
    {
        USES S-STEP "AppIndivSearchFTJULU";
        SearchTitle -> Title;
    }

    IF action == "ACTION_PREVIOUS" || action == "ACTION_NEXT"
    {
        LastAction = action;
