...
INCLUDE "BF0814-O.s";
INCLUDE "BF0814-P.p";
INCLUDE "BF0810Retrieve.f";
INCLUDE "BF0811Create.f";
INCLUDE "BF0812Update.f";
INCLUDE "BF0813Delete.f";

PROCESS BF0814List
{
    Title = STRINGTABLE.IDS_TITLE_BF0814List;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
