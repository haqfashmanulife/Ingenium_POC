...
#// 2.  For the "Find What:" Field, enter "158" (without quotations).
#// 3.  For the "Replace With:" Field, enter the first three digits of your BFID.
#// 4.  Choose the Replace All Function.
#// 5.  Now, in the "Find What:" Field, enter "NCWM1580" (without quotations).
...
#// 13. Replace the "158" part of the file name with the first three digits of your BFID.
#// 14. Save the File
#///
...
PROCESS BF1583Delete
{
    STEP Main
    {
        USES PROCESS "GenDelete";
        STRINGTABLE.IDS_TITLE_BF1583Delete -> Title;
