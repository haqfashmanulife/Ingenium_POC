...
PROCESS BF1352Reject
{

    # Set up the title strings. The names of the string table

    ProcessTitle = STRINGTABLE.IDS_TITLE_BF1352Process;
    Phase1Title = STRINGTABLE.IDS_TITLE_BF1352Phase1;
    Phase2Title = STRINGTABLE.IDS_TITLE_BF1352Phase2;
    Phase3Title = STRINGTABLE.IDS_TITLE_BF1352Phase3;
    Title = ProcessTitle;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
