...
#// 2.  For the "Find What:" Field, enter "132" (without quotations).
#// 3.  For the "Replace With:" Field, enter the first three digits of your BFID.
#// 4.  Choose the Replace All Function.
#// 5.  Now, in the "Find What:" Field, enter "CCWM0351" (without quotations).
...
#// 13. Replace the "132" part of the file name with the first three digits of your BFID.
#// 14. Save the File
#///
...
PROCESS BF1323Delete
{
    STEP Main
    {
        USES PROCESS "GenDelete";
        STRINGTABLE.IDS_TITLE_BF1323Delete -> Title;
