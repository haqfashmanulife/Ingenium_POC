...
P-STEP BF1291-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "1291";
        BusinessFunctionName = "Cash Receipts Reversals";
        BusinessFunctionType = "Cshrevs";
        MirName = "CCWM0241";
        Description;
    }
    ...
    INOUT MIR-DV-ACCT-DESC-TXT-T[11]
    {
        Length = "20";
        FieldGroup = "Table11";
        DBTableName = "TACTD";
    ...
    INOUT MIR-DV-SCRN-ACCT-DESC-TXT-T[11]
    {
        Length = "14";
        FieldGroup = "Table11";
        DBTableName = "Derived";
    ...
    INOUT MIR-DV-TRNXT-CR-AMT-T[11]
    {
        Signed;
        Length = "13";
        FieldGroup = "Table11";
    ...
    INOUT MIR-DV-TRNXT-DR-AMT-T[11]
    {
        Signed;
        Length = "13";
        FieldGroup = "Table11";
