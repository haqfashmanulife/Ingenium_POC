...
PROCESS BF9C91WL
{
    ...
    TRACE("MIR-SETL-OPT-IND: BEFORE DV - 2 P STEP :"+MIR-SETL-OPT-IND);
    STEP BF9C91-P2
    {
      USES P-STEP "BF9C91-P";
      "2" -> MIR-DV-PRCES-STATE-CD;
    }
      MIR-SETL-OPT-IND = WS-SETL-OPT-IND;
    TRACE("MIR-SETL-OPT-IND: AFTER DV - 2 P STEP :"+MIR-SETL-OPT-IND);
    IF LSIR-RETURN-CD != "00"
    {
      BRANCH BF9C91WL-I;
    }
    ...
    IF action == "ACTION_BACK"
    {
      ...
      WS-SETL-OPT-IND = MIR-SETL-OPT-IND;
    TRACE("MIR-SETL-OPT-IND: BEFORE DV - 3 P STEP :"+MIR-SETL-OPT-IND);
    STEP BF9C91-P3
    {
       USES P-STEP "BF9C91-P";
