...
P-STEP BF0400-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "0400";
        BusinessFunctionName = "Health Plan Packaging Retrieve";
    ...
    OUT MIR-OWN-OCCP-ALLOW-CD-T[100]
    {
        Length = "1";
        FieldGroup = "Table100";
        CodeSource = "DataModel";
    ...
    OUT MIR-REDC-EP-ALLOW-CD-T[100]
    {
        Length = "1";
        FieldGroup = "Table100";
        CodeSource = "DataModel";
