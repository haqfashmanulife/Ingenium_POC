...
INCLUDE "BF1581Create.f";
INCLUDE "BF1582Update.f";
INCLUDE "BF1583Delete.f";

PROCESS BF1584List
{
    Title = STRINGTABLE.IDS_TITLE_BF1584List;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
