...
#// 2.  For the "Find What:" Field, enter "154" (without quotations).
#// 3.  For the "Replace With:" Field, enter the first three digits of your BFID.
#// 4.  Choose the Replace All Function.
#// 5.  Now, in the "Find What:" Field, enter "NCWM1540" (without quotations).
...
#// 13. Replace the "154" part of the file name with the first three digits of your BFID.
#// 14. Save the File
#///
...
PROCESS BF1543Delete
{
    STEP Main
    {
        USES PROCESS "GenDelete";
        STRINGTABLE.IDS_TITLE_BF1543Delete -> Title;
