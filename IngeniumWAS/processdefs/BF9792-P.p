...
P-STEP BF9792-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "9792";
        BusinessFunctionName = "AVE Reformat Control Table Update";
    ...
    INOUT MIR-RENW-PLAN-ID
    {
        ...
        DBTableName = "TAVE";
        SType = "Selection";
        Label = "Renewal Plan Code";
    }

    INOUT MIR-RENW-PLAN-ID-2
    {
        Length = "6";
        DBTableName = "TAVE";
        SType = "Text";
        Label = "Renewal Plan ID";
    }
    ...
    INOUT MIR-MAX-AGE-PLAN-ID
    {
        ...
        DBTableName = "TAVE";
        SType = "Selection";
        Label = "Max Age Plan Code";
    }

    INOUT MIR-MAX-AGE-PLAN-ID-2
    {
        Length = "6";
        DBTableName = "TAVE";
        SType = "Text";
        Label = "Max Age Plan ID";
    }
