...
P-STEP BF1735-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "1735";
        BusinessFunctionName = "Fund Inquiry - Accumulation Units";
    ...
    OUT MIR-FIA-AUNIT-PRIC-AMT-T[139]
    {
        Length = "17";
        Decimals = "9";
        FieldGroup = "Table139";
    ...
    OUT MIR-FIA-INTG-AUNIT-QTY-T[139]
    {
        Length = "13";
        Decimals = "9";
        FieldGroup = "Table139";
