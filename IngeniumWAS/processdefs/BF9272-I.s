...
#*******************************************************************************
#*  Component:   BF9272-I.s                                                    *
#*  Description: Adjudicator Decision Summary - Update screen                  *
#*                                                                             *
#*******************************************************************************
...
#*  P034    CSE022   The attributes of BNFT-DECSN-CD field is changed to       *
#*                   accomodate the decision text value as part of new         *
#*                   filter selection program CSOM9997(as part of EN000292)    *
...
#*  105748  CTS      FIX FOR NON-PAYMENT REASON CODE                           *
...
#** CS0008 CHANGES
	...
	INOUT MIR-BNFT-DECSN-CD-T[100] 
	{
		...
		FieldGroup = "Table1";
		Index = "1";
#** P034: Changed the value of Code Source to the filter selection program CSOM9997 
#*              CodeSource = "DataModel";
#*		CodeType = "CLBN-BNFT-DECSN-CD";
		CodeSource = "CSOM9997";
                FilterFields = "1";
                FilterField1 = "MIR-CO-ID";
		SType = "Selection";
		Label = "Decision";
	}
#* CS0008 CHANGES STARTS HERE
#* 105748 CHANGES STARTS HERE
