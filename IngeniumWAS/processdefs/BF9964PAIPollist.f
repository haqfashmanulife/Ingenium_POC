...
#*                   pages will replace the exsiting ones.  Added a variable   *
#*                   switch to control the button functions.                   *
#*******************************************************************************
#INCLUDE "BF9964-I.s";
INCLUDE "BF9964-O.s";
INCLUDE "BF9964-P.p";
#* MFFPI
#INCLUDE "BF9965PAIPolicyInquiry.f";

PROCESS BF9964PAIPollist
{
    Title = STRINGTABLE.IDS_TITLE_BF9964PAIPollist;
    TitleBar = "TitleBar";
    TitleBarSize = "70";
