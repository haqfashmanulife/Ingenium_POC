...
PROCESS BF1290Cshrcpt
{
    STEP Main
    {
        ...
        STRINGTABLE.IDS_TITLE_BF1290Process -> ProcessTitle;
        STRINGTABLE.IDS_TITLE_BF1290Phase1 -> Phase1Title;
        STRINGTABLE.IDS_TITLE_BF1290Phase2 -> Phase2Title;
        STRINGTABLE.IDS_TITLE_BF1290Phase3 -> Phase3Title;
        ...
        "BF1290-P" -> GetInitialHostDataP;
        "BF1290-I" -> DataInputS;
        "BF1290-P" -> PerformHostEditsP;
        "BF1290-O" -> ConfirmS;
        "BF1290-P" -> UpdateHostP;
