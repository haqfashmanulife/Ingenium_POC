...
#</HISTORY>
#</HEADER>
# Executes both the epilog and sign-off for a headless flow
PROCESS ProcessEpilogHeadless
{
	# The process epilog and sign-off should only be done if the user
	# is signed on.
	# If SESSION.LSIR-SECUR-CLAS-ID has a value, the user is signed on.
	# If it's blank, the user isn't signed on.
	IF SESSION.LSIR-SECUR-CLAS-ID != ""
	{
		# ****************************************************************
		# Process Epilog
		# ****************************************************************
