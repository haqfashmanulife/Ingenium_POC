...
S-STEP BF0253Nontrad-O
{
    ...
    IN MIR-DV-CRNT-FNDVL-AMT-T[100]
    {
        DisplayOnly;
        Length = "13";
        FieldGroup = "Table100";
    ...
    IN MIR-DV-CRNT-SURR-VALU-AMT-T[100]
    {
        DisplayOnly;
        Length = "13";
        FieldGroup = "Table100";
    ...
    IN MIR-DV-GUAR-FNDVL-AMT-T[100]
    {
        DisplayOnly;
        Length = "13";
        FieldGroup = "Table100";
    ...
    IN MIR-DV-GUAR-SURR-VALU-AMT-T[100]
    {
        DisplayOnly;
        Length = "13";
        FieldGroup = "Table100";
    ...
    IN MIR-DV-POL-CRNT-DB-AMT-T[100]
    {
        DisplayOnly;
        Length = "13";
        FieldGroup = "Table100";
