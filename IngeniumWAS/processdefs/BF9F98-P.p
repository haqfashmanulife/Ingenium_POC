...
P-STEP BF9F98-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "9F98";
        BusinessFunctionName = "CWA Refund / Rejection Request Inquiry";
    ...
    INOUT MIR-POL-APP-FORM-ID-T[20]
    {
        Length = "15";
        FieldGroup = "Table20";
        SType = "Text";
    ...
    OUT MIR-CWA-RFND-SUSP-AMT-T[20]
    {
        Signed;
        Length = "17";
        FieldGroup = "Table20";
...
# CA02CR changes begins
    ...
    OUT MIR-RFND-BNK-ACCT-ID-T[20]
    {
     ...
     OUT MIR-RFND-ACCT-HLDR-NM-T[20]
    {
        Length = "75";
        FieldGroup = "Table20";
        DBTableName = "TRFND";
