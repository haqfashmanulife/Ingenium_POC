...
#*  Q10539  CTS      FIX FOR THE XML OUTPUT FLAGS                              *
...
P-STEP BF9B50-P
{
    ATTRIBUTES
    {
        BusinessFunctionId = "9B50";
        BusinessFunctionName = "Underwriting Guidance Tool";
...
#Q10433 CHNAGES END
    ...
    INOUT MIR-PREF-MSG-CD
    {
        DisplayOnly;
        Length = "1";
#Q10539 CHNAGES START
#       CodeSource = "DataModel";
