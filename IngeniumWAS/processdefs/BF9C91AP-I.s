#*******************************************************************************
#*  Component:   BF9C91AP-I.s                                                  *
#*  Description: Input Edit Step for Advance Payment Activity Create Process   *
#*                                                                             *
#*******************************************************************************
    ...
    S-STEP BF9C91AP-I
{
    ...
    FocusField = "MIR-POL-ADV-PMT-AMT";
    ...
    {
    Key;
    Label = "Advance Payment Effective Date";
    Length = "10";
    Mandatory;
    SType = "Date";
    }
