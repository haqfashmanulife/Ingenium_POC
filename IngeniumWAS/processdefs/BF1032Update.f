...
# INCLUDE "GenUpdate.f";
# INCLUDE "BFUpdateAudBnk.f";
INCLUDE "BF9G99-P.p";
# 23774A CHANGES END

PROCESS BF1032Update
{
#* 23774A CHANGES START
#    STEP Main
#    {
#           USES PROCESS "GenUpdate";
#           USES PROCESS "BFUpdateAudBnk";
#        ATTRIBUTES
#        {
#            GetMessages = "NO";
#        }
#
#        STRINGTABLE.IDS_TITLE_BF1032Update -> Title;
#        "BF1030-I" -> InputS;
#        "BF1030-P" -> RetrieveP;
#        "BF1032-I" -> EditS;
#        "BF1032-P" -> UpdateP;
...
#    BRANCH Main;
    ...
    Title = STRINGTABLE.IDS_TITLE_BF1032Update;     
    TitleBar = "TitleBar";
    TitleBarSize = "70";
