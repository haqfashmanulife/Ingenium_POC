...
//-----------------------------------------------------------------------------
//
//	Functions for Asit pages (BF211x)
//
//-----------------------------------------------------------------------------
...
//
//	Description:	Custom onLoad functionality required for Asit
//
//	Arguments:	none
//
//	Returns:	Nothing
...
//	Returns:	Nothing
//
//	Uses:       changeFormatInfo from Asit.js
//
//-----------------------------------------------------------------------------

function onLoadCustomFormat()
{
	ctl = document.getElementById("MIR-OVRID-MAX-AMT-PCT");

	// change formatting info according to value of MIR-OVRID-MAX-TYP-CD
	// and scale the field
	ctlFld = document.getElementById("MIR-OVRID-MAX-TYP-CD");
	if (ctlFld != null)
	{
