...
//-----------------------------------------------------------------------------
//
//  Functions for the AppPolicyDataUL.htm page
//
...
function applyTheRequirements(index)
{
  ...
  field2                 = document.getElementById("MIR-CVG-WP-IND-T["      + tIndex + "]");

  controllingFieldValue  = document.getElementById("MIR-PLAN-PKG-ADB-CD-T[" + tIndex + "]").value;
  controllingFieldValue2 = document.getElementById("MIR-PLAN-PKG-WP-CD-T["  + tIndex + "]").value;
