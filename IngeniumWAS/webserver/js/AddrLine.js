...
//----------------------------------------------------------------------------
//
//	Function:	AddrKALine1
//
//	Description:	Selects an Entry from the selection box and populates
//                      the address line 1 (Katakana)
//
//	Arguments:	None
//
//	Returns:	Nothing
...
function AddrKALine1()
{
	document.getElementById("MIR-CLI-ADDR-LN-1-TXT-T[2]").value = document.getElementById("MIR-PSTL-ADDR-LN-1-TXT-2").options[document.getElementById("MIR-PSTL-ADDR-LN-1-TXT-2").selectedIndex].text

}

//----------------------------------------------------------------------------
//
//	Function:	AddrKALine2
//
//	Description:	Selects an Entry from the selection box and populates
//                      the address line 2 (Katakana)
//
//	Arguments:	None
//
//	Returns:	Nothing
...
function AddrKALine2()
{
	document.getElementById("MIR-CLI-ADDR-LN-2-TXT-T[2]").value = document.getElementById("MIR-PSTL-ADDR-LN-2-TXT-2").options[document.getElementById("MIR-PSTL-ADDR-LN-2-TXT-2").selectedIndex].text
