...
//******************************************************************************
//*  Component:   AppAllocationsVUL.js                                         *
//*  Description:                                                              *
//*                                                                            *
//******************************************************************************
...
//-----------------------------------------------------------------------------
//
//  Functions for the AppAllocationsVUL.htm page
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
//  Function:       onLoadAppAllocationsVUL()
//
...
function onLoadAppAllocationsVUL()
{
  ...
  // Simulate click on appropriate AssetRebalance radio button to restore state.
  if (inputForm.AssetRebalance[0].checked)
  {
    inputForm.AssetRebalance[0].click();
  }
  else
  {
    inputForm.AssetRebalance[1].click();
  }
...
//      setting mandatory status for MIR-AR-START-DT and MIR-POL-PAYO-MODE-CD
//
//  Arguments:  none
//
//  Returns:  Nothing
...
function toggleRebalSection()
{
  if (inputForm.AssetRebalance[0].checked)
  {
    changeMandatoryFor(ARSection, "yes");
    ARSection.style.display = "Block";
  }
  else
  {
    changeMandatoryFor(ARSection, "no");
