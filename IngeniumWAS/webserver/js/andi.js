...
//-----------------------------------------------------------------------------
//
//	Functions for ANDI pages (BF092x)
//
//-----------------------------------------------------------------------------
...
//	Returns:	Nothing
//
//	Uses:       changeFormatInfo from andi.js
//
//-----------------------------------------------------------------------------
...
function onLoadCustomFormat()
{
	...
	{
		ctl = document.getElementById("MIR-CDI-ALLOC-AMT-T[" + i + "]");
		if (ctl == null)
		{
...
function onChangeScalingCustom(ctlCd)
{
    ...
    ctl = document.getElementById("MIR-CDI-ALLOC-AMT-T[" + fldName.substr(19));
