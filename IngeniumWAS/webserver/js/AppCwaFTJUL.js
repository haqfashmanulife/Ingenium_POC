...
//******************************************************************************
//*  Component:   AppCwaFTJUL.js                                               *
//*  Description: Cloned from AppCwaJPUL.js                                    *
//*                                                                            *
//******************************************************************************
//*  Chg#    Release  Description                                              *
//*                                                                            *
//*  016423  602J     New for release 602J                                     *
//*  01NB01  GW       New for MCL release - New App. Entry Flow                *
...
//-----------------------------------------------------------------------------
//
//	Functions for the AppCwaFTJUL.htm and VulCwaConfirm pages
//
...
function showCashWithAppFields(ctl)
{
	...
	if ("Y" == ctlValue)
	{
		...
		document.getElementById("MIR-RECPT-AMT").setAttribute("mandatory", "yes");
		document.getElementById("MIR-RECPT-DT").setAttribute("mandatory", "yes");
		document.getElementById("MIR-RECPT-NBR").setAttribute("mandatory", "yes");
	}
	//
	...
	else
	{
		...
		document.getElementById("MIR-RECPT-DT").setAttribute("mandatory", "no");
		document.getElementById("MIR-RECPT-DT").value          = document.getElementById("MIR-RECPT-DT").defaultValue;

		document.getElementById("MIR-RECPT-NBR").setAttribute("mandatory", "no");
		document.getElementById("MIR-RECPT-NBR").value          = document.getElementById("MIR-RECPT-NBR").defaultValue;
		
		document.getElementById("MIR-RECPT-AMT").setAttribute("mandatory", "no");
		document.getElementById("MIR-RECPT-AMT").value      = document.getElementById("MIR-RECPT-AMT").defaultValue;
	}
}
