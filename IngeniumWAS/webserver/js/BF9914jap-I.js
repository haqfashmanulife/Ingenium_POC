...
function onClickSrchTypCd()
{
     ...
     {
         document.getElementById('PRODRADIO').innerText = "小種 ・ 証券番号";
         document.getElementById('PRODCD').innerText = "小種:";
         document.getElementById('POLID').innerText = "証券番号:";
     }

     if (document.getElementsByName("MIR-SRCH-TYP-CD")[1].checked)     
     {
         document.getElementById('PRODRADIO').innerText = "設計書番号 ・ 申込書番号";
         document.getElementById('PRODCD').innerText = "設計書番号:";
         document.getElementById('POLID').innerText = "申込書番号:";
     }
