...
//-----------------------------------------------------------------------------
//
//  Functions for the AppSignaturesFTJ.htm page
//
//-----------------------------------------------------------------------------
//
//  Functions for the AppPolicyDataFTJUL.htm page
//
...
function showHideSplitCommissionInfo(ctl)
{
  ...
  if ("Y" == ctlValue)
  {
    ...
    document.getElementById("SplitCommissionTable").rows[0].cells[colAgentType].style.display = "";
    document.getElementById("SplitCommissionTable").rows[1].cells[colAgentType].style.display = "";
          document.getElementById("MIR-POL-AGT-SHR-PCT-T[1]").style.display = "";
          document.getElementById("MIR-POL-AGT-SHR-PCT-T[1]").value = "50.00%";
          document.getElementById("MIR-POL-AGT-TYP-CD-T[1]").style.display = "";
    ...
    for (var index = 2; index <= maxSplits; index++)
    {
      document.getElementById("SplitCommissionTable").rows[index].cells[colSplitPercentage].style.display = "";
            document.getElementById("SplitCommissionTable").rows[index].cells[colAgentType].style.display = "";
      ...
      document.getElementById("MIR-POL-AGT-SHR-PCT-T[" + index + "]").value = "50.00%";
            document.getElementById("MIR-POL-AGT-TYP-CD-T[" + index + "]").style.display = "";
  ...
  else
  {
    ...
    if (thereIsData())
    {
      ...
      //
      // msg: Values entered for agent 2 will be reset to blank - confirm
    ...
    if (bHide)
    {
      ...
      document.getElementById("SplitCommissionTable").rows[1].cells[colSplitPercentage].style.display = "none";
            document.getElementById("SplitCommissionTable").rows[0].cells[colAgentType].style.display = "none";
      document.getElementById("SplitCommissionTable").rows[1].cells[colAgentType].style.display = "none";
            document.getElementById("MIR-POL-AGT-SHR-PCT-T[1]").style.display = "none";
                      document.getElementById("MIR-POL-AGT-TYP-CD-T[1]").style.display  = "none";

      for (var index = 2; index <= maxSplits; index++)
      {
        document.getElementById("SplitCommissionTable").rows[index].cells[colSplitPercentage].style.display = "none";
                    document.getElementById("SplitCommissionTable").rows[index].cells[colAgentType].style.display = "none";
        ...
        document.getElementById("MIR-POL-AGT-SHR-PCT-T[" + index + "]").style.display = "none";
                        document.getElementById("MIR-POL-AGT-TYP-CD-T[" + index + "]").style.display  = "none";
        ...
        document.getElementById("MIR-POL-AGT-SHR-PCT-T[" + index + "]").value   = "";
                    document.getElementById("MIR-POL-AGT-TYP-CD-T[" + index + "]").value    = "";
      }
    }
  }
}
...
function thereIsData()
{
  ...
  for (var index = 2; index <= maxSplits; index++)
  {
    if ((cleanString(document.getElementById("MIR-DV-AGT-CLI-NM-T[" + index + "]").innerText)!= "") ||
      ...
      (cleanString(document.getElementById("MIR-POL-AGT-TYP-CD-T[" + index + "]").value)   != "") ||
