      ...
      **            PRODUCE A FILE OF TERMINATED CASE INFO           **
      *****************************************************************
...
53-062 COPY XCWWPGWS REPLACING '$VAR1' BY 'ZSBMCMBT'.
      ...
      *--------------------
           ...
           MOVE 'ZSBMCMBT'           TO WGLOB-MAIN-PGM-ID.                      
           ...
           MOVE 'ZSBMCMBT'           TO WGLOB-CRNT-PGM-ID                       
                                        WGLOB-USER-ID.                          

           MOVE SPACES TO WS-PREV-POL-ID.    

           MOVE SPACES TO RCMBT-SEQ-REC-INFO.
      ...
      *    ADD RCMBE-CMB-ERR-AMT       TO WS-CMB-ERR-AMT.                       
      *    ADD RCMBE-CMB-NEW-AMT       TO WS-CMB-NEW-AMT.                       
      ...
      *    MOVE WWKDT-HIGH-DT      TO WS-OLDEST-BAD-DT.                         
           ...
           MOVE SPACES             TO RCMBT-SEQ-REC-INFO.                       
           MOVE RCMBE-POL-ID       TO RCMBT-POL-ID.                             
           MOVE RCMBE-POL-STAT     TO RCMBT-POL-STAT.                           
           MOVE RCMBE-ISS-DT       TO RCMBT-ISS-DT.                             
           MOVE RCMBE-POL-TYP      TO RCMBT-POL-TYP.
      ...
      *MSG: (S) 'POLICY RECORD NOT FOUND'
           ...
           MOVE RPOL-POL-CEAS-DT        TO RCMBT-CEASE-DT.                      
           MOVE RPOL-POL-OS-DISB-AMT    TO RCMBT-OS-DISB-AMT.                   
           MOVE RPOL-OS-DISB-AD-AMT     TO RCMBT-OS-DISB-AD-AMT.                
           MOVE RPOL-OS-DISB-CLM-AMT    TO RCMBT-OS-DISB-CLM-AMT.               
           MOVE RPOL-OS-DISB-DTH-AMT    TO RCMBT-OS-DISB-DTH-AMT.               
           MOVE RPOL-OS-DISB-MAT-AMT    TO RCMBT-OS-DISB-MAT-AMT.               
           MOVE RPOL-OS-DISB-SURR-AMT   TO RCMBT-OS-DISB-SURR-AMT.              
           MOVE RPOL-POST-LAPS-SURR-AMT TO RCMBT-POST-LAPS-SURR-AMT.            
           MOVE RPOL-POL-SUB-STAT-CD    TO RCMBT-SUB-STAT-CD.                   
           MOVE RPOL-POL-CNVR-TYP-CD    TO RCMBT-CNVR-TYP-CD.                   
      ...
      *    MOVE RCMBT-ISS-DT       TO WS-ANNIV-DT.                              
      *    PERFORM  3100-FIND-ANNIV-DATE                                        
      *        THRU 3100-FIND-ANNIV-DATE-X                                      
      *        UNTIL WS-ANNIV-FOUND.                                            

      *    IF WS-ANNIV-DT > RCMBT-CEASE-DT                                      
      *        MOVE 'TN'           TO RCMBT-POL-TYP                             
      *    ELSE                                                                 
      *        MOVE 'TB'           TO RCMBT-POL-TYP                             
      *    END-IF.                                                              

           MOVE 0                       TO WS-CMB-ERR-AMT.                      
           MOVE 0                       TO WS-CMB-NEW-AMT.                      
           MOVE RCMBT-ISS-DT            TO WS-ANNIV-DT.                         
           PERFORM 3050-BUILD-IT                                                
              THRU 3050-BUILD-IT-X                                              
              VARYING J FROM 1 BY 1                                             
                UNTIL J > WS-SAVE-UH-MAX.                                       

           COMPUTE RCMBT-CMB-DIFF = WS-CMB-NEW-AMT - WS-CMB-ERR-AMT.            

           PERFORM 9400-CMBT-WRITE                                              
              THRU 9400-CMBT-WRITE-X.                                           
      ...
      *--------------
           ...
           IF RCFLW-CF-PRCES-DT > '2004-02-15'                                  
               MOVE RCFLW-KEY           TO WCFLW-KEY                            
               MOVE WCFLW-KEY           TO WCFLW-ENDBR-KEY                      
      *        MOVE RPOL-POL-ID         TO WCFLW-ENDBR-POL-ID                   
      *        MOVE '001'               TO WCFLW-ENDBR-CVG-NUM                  
      *        MOVE 'D'                 TO WCFLW-ENDBR-CF-TYP-CD                
           ...
           ADD WS-CMB-CFLW-AMT            TO WS-CMB-ERR-AMT.                    
...
02PR62*    END-IF.
      ...
      *       THRU 9495-1000-CALC-CBB-AMTS-X.
           ...
           ADD L9495-CMB-AMT              TO WS-CMB-NEW-AMT.                    

      *    IF WS-BLD-CNT = 1                                                    
      *        MOVE WS-ANNIV-DT            TO RCMBL-CMB-DATE1                   
      *    ELSE                                                                 
      *        MOVE WS-ANNIV-DT            TO RCMBL-CMB-DATE2                   
      *    END-IF.
      ...
      *--------------------                                                     
           ...
           IF WS-BLD-CNT = 1                                                    
               MOVE RCFLW-CF-EFF-DT        TO RCMBT-CMB-DATE1                   
      *        MOVE RCFLW-CF-CLI-TRXN-AMT  TO RCMBL-CMB1-OLD-AMT                
           ELSE                                                                 
               MOVE RCFLW-CF-EFF-DT        TO RCMBT-CMB-DATE2                   
      *        MOVE RCFLW-CF-CLI-TRXN-AMT  TO RCMBL-CMB2-OLD-AMT                
           END-IF.
      ...
      *    IF WS-BLD-CNT = 1                                                    
      *        MOVE RCFLW-CF-EFF-DT        TO RCMBL-CMB1-DT                     
      *        MOVE RCFLW-CF-CLI-TRXN-AMT  TO RCMBL-CMB1-OLD-AMT                
      *    ELSE                                                                 
      *        MOVE RCFLW-CF-EFF-DT        TO RCMBL-CMB2-DT                     
      *        MOVE RCFLW-CF-CLI-TRXN-AMT  TO RCMBL-CMB2-OLD-AMT                
      *    END-IF.
...
2DAC01     END-IF.
      ...
      *    MOVE RCMBL-ISS-DT        TO WS-ISS-DT.                               
