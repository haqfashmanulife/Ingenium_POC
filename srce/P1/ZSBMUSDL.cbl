...
015550**  14MAR2019 CTS    INITIAL REVISION                          **
      ...
      *************************
       COPY XCWWPGWS REPLACING '$VAR1' BY 'ZSBMUSDL'.
      ...
      /
        ...
        01  WS-931A-OLD-SEQ-REC-INFO.
           ...
           05  WS-931A-STICKER-NUM                PIC X(11).
           05  FILLER                             PIC X(09).
           05  WS-931A-USDL-SHEET-ID              PIC X(05).
           ...
           05  WS-931A-SELF-SEX-CD.
               10  WS-931A-SELF-SEX-MALE          PIC X(01).
               10  WS-931A-SELF-SEX-FMALE         PIC X(01).
           05  FILLER                             PIC X(06).
           05  WS-931A-SELF-DSCLSRE-DT            PIC X(06).
           05  WS-931A-SELF-REL-IND.
               10  WS-931A-SELF-REL-PARENT        PIC X(01).
               10  WS-931A-SELF-REL-OTHER         PIC X(01).
           05  FILLER                             PIC X(09).
           05  WS-931A-SELF-HEIGHT-HT             PIC X(03).
           05  WS-931A-SELF-WEIGHT-WGT            PIC X(03).
           05  WS-931A-SELF-MEDEXM-5YRS-IND.
               10  WS-931A-SELF-MEDEXM-5YRS-YES   PIC X(01).
               10  WS-931A-SELF-MEDEXM-5YRS-NO    PIC X(01).
           05  WS-931A-SELF-EXAM-3MO-IND.
               10  WS-931A-SELF-EXAM-3MO-YES      PIC X(01).
               10  WS-931A-SELF-EXAM-3MO-NO       PIC X(01).
           05  WS-931A-SELF-HOSP-2YRS-IND.
               10  WS-931A-SELF-HOSP-2YRS-YES     PIC X(01).
               10  WS-931A-SELF-HOSP-2YRS-NO      PIC X(01).
           05  WS-931A-SELF-VISION-IND.
               10  WS-931A-SELF-VISION-YES        PIC X(01).
               10  WS-931A-SELF-VISION-NO         PIC X(01).
           05  FILLER                             PIC X(10).
           05  WS-931A-DUP-WFI-NUM                PIC X(01).
           05  WS-931A-SELF-SMOKER-IND.
               10  WS-931A-SELF-SMOKER-YES        PIC X(01).
               10  WS-931A-SELF-SMOKER-NO         PIC X(01).
           05  WS-931A-SELF-SMK-CIGAR-QTY         PIC X(02).
