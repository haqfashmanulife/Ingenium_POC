...
015550**  14MAR2019 CTS    INITIAL REVISION                          **
      ...
      *************************
       COPY XCWWPGWS REPLACING '$VAR1' BY 'ZSBMUFMF'.
      ...
      /
       01  WS-931A-OLD-SEQ-REC-INFO.  
           ...
           05  WS-931A-MED-PHYS-IRREG-IND         PIC X(02).                         
           05  WS-931A-MED-CMPLXN-IND             PIC X(02).                 
           05  WS-931A-MED-SKIN-IRREG-IND         PIC X(02).              
           05  WS-931A-MED-PSTRE-IND              PIC X(02).                      
           05  WS-931A-MED-NERV-SYS-IND           PIC X(02).               
           05  WS-931A-MED-MOTR-ORGN-IND          PIC X(02).                    
           05  WS-931A-MED-ABNORM-MVT-IND         PIC X(02).                       
           ...
           05  WS-931A-MED-EXAM-NOT-OCCR-IND      PIC X(01).                          
           05  FILLER                             PIC X(02).                          
