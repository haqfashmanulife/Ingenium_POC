      ...
      **                                                             **
006002** 15DEC99   60     NEW PROGRAM FOR DMAD UPDATE                **
014590**  15DEC99  60     ARCHITECTURAL CHANGES                      **
      ...
      ***************
       ...
       COPY XCWWPGWS REPLACING '$VAR1' BY 'XSOM8102'.
...
014590*COPY XCWL0030.
      /
       01  WS-WORKING-STORAGE.
           05  WS-BUS-FCN-ID                 PIC X(04).
               88  WS-BUS-FCN-UPDATE         VALUE '8102'.
      /
      *****************************************************************
      *  COMMON COPYBOOKS                                             *
      *****************************************************************
      ...
      *MSG: 'RECORD (@1) NOT FOUND'
           ...
           PERFORM  DMAD-2000-REWRITE
               THRU DMAD-2000-REWRITE-X.
      ...
      *-----------
           ...
           MOVE MIR-DM-AV-DESC-TXT     TO RDMAD-DM-AV-DESC-TXT.
