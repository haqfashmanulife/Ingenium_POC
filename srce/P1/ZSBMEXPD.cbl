      *****************************************************************
      **  MEMBER : ZSBMEXPD                                          **
      **  REMARKS: ZAP PROGRAM FOR RECALCULATING THE MATURITY/EXPIRY **         
      **           DATE FOR THE EXISTING SUBSTANDARD RATED TERM LIFE **    
      **           OR MEDICAL RIDERS                                 **
      *****************************************************************
      **  DATE     AUTHOR DESCRIPTION                                **
      **                                                             **
02PR59**  19MAR02  RNL    (NEW) RE-INITIALIZING MAT/EXP DATE         **
P02229**  20OCT04  CY     ADD COMMIT LOGIC TO MAINLINES              **
      ...
      *=======================
      *
       COPY XCWWPGWS REPLACING '$VAR1' BY 'ZSBMEXPD'.
      ...
      *
       01  WS-CTL-REPORT-TITLE1.
           05  FILLER                 PIC X(08) VALUE 'ZSBMEXPD'.
       ...
       01  WS-CTL-REPORT-DATA.
           ...
           05  WS-CTL-ORI-M-E-DT      PIC X(10).
           05  FILLER                 PIC X(06) VALUE SPACES.
           05  WS-CTL-NEW-M-E-DT      PIC X(10).
           05  FILLER                 PIC X(06) VALUE SPACES.
...
P02229 COPY XCWL0035.
      ...
      *
      ...
      /
       01  MISC-WORK-AREAS.
           05  WS-PROGRAM-ID    PIC X(08)      VALUE 'ZSBMEXPD'.
      /
      *===================
       PROCEDURE DIVISION.
      *===================
...
P02229         THRU 0035-1000-COMMIT-X.
      ...
      *
           ...
           MOVE 'MAT/EXP. DATES FOR SUBSTANDARD RIDERS CONVERTION'
                                   TO L0040-HDG-LINE-3.
      *
      ...
      *                 
           ...
           OR   RPH-PREM-CHNG-DT-CD = 'S')
               PERFORM  5000-RESET-COV-M-E-DATE
                  THRU  5000-RESET-COV-M-E-DATE-X
           END-IF.
      *
      ...
      /
      *----------------------
       5000-RESET-COV-M-E-DATE.
      *----------------------
      *
           PERFORM  MIDT-1000-MOVE-ISS-DT-TO-DT1
               THRU MIDT-1000-MOVE-ISS-DT-TO-DT1-X.
      *
      *    MAKE SURE COVERAGE ISSUE DATE IS THERE
      *
           IF  WWKDT-INT-DT-1 = WWKDT-ZERO-DT
               GO TO 5000-RESET-COV-M-E-DATE-X
           END-IF.
      *
      ...
      *
           ...
           MOVE WCVGS-CVG-MAT-XPRY-DT (I) TO WS-CTL-NEW-M-E-DT.
      *
