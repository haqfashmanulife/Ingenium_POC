      ...
      *****************************************************************
      **  MEMBER :  VSBM1100                                         **
      **  REMARKS:  DUE AND PAID IN ADVANCE ANNUITY REPORT           **
      **                                                             **
      **  DOMAIN :  AT                                               **
      **  CLASS  :  PD                                               **
      *****************************************************************
...
011652**  30OCT98  56     REPLACE COPYBOOK CCWWDHG WITH XCWWHDG      **
...
P02229**  20OCT04  CY     ADD COMMIT LOGIC TO MAINLINES              **
      ...
      *************************
       ...
       COPY XCWWPGWS REPLACING '$VAR1' BY 'VSBM1100'.
...
008453     02  FILLER                             PIC X(52).
       ...
       01  WORK-AREAS-DISPLAY.
           03  W1100-EOF-SW  VALUE 'N'              PIC X.
               88  W1100-FILE-EMPTY       VALUES 'Y'.
 
           03  IMMANN-FILE-STAT                   PIC 99.
...
P02229         THRU 0035-1000-COMMIT-X.
      ...
      *----------------
           ...
           PERFORM  1100-1000-OPEN-INPUT
               THRU 1100-1000-OPEN-INPUT-X.
...
007684     IF  WBCF-SEQ-IO-EOF
               MOVE 'VS11000001'   TO WGLOB-MSG-REF-INFO
...
008453     END-IF.
           ...
           IF  NOT VALID-REP-TYPE
               MOVE 'VS11000002'   TO WGLOB-MSG-REF-INFO
               PERFORM  0260-1000-GENERATE-MESSAGE
                   THRU 0260-1000-GENERATE-MESSAGE-X
               PERFORM  0030-4000-CTL-CARD-ERROR
                   THRU 0030-4000-CTL-CARD-ERROR-X
...
011652*    MOVE 'VSBM1100'         TO HDG2-PROGRAM.
...
011652     MOVE L0950-COMPANY-TIME     TO WHDG-TIME.
      ...
      ***  READ FIRST RECORD
           ...
           PERFORM  1100-1000-READ
               THRU 1100-1000-READ-X.
 
007684     IF  W1100-SEQ-IO-EOF
               MOVE 'Y'                TO W1100-EOF-SW
               MOVE 'VS11000003'       TO WGLOB-MSG-REF-INFO
               MOVE 'VSBM1100'         TO WGLOB-MSG-PARM (1)
               PERFORM  0260-1000-GENERATE-MESSAGE
                   THRU 0260-1000-GENERATE-MESSAGE-X
           END-IF.
...
007684     IF  W1100-SEQ-IO-EOF
      ...
      *------------------
           ...
           MOVE R1100-LOB         TO CURRENT-LOB.
           MOVE R1100-PAR         TO CURRENT-PAR.
      ...
      *-----------------
           ...
           MOVE R1100-POLICY             TO P-POLICY-NUMBER.
           MOVE R1100-RIDER-NUM          TO P-TRAILER-NUMBER.
 
           MOVE R1100-ISSUE-DATE         TO L1640-INTERNAL-DATE.
           ...
           MOVE R1100-PAID-TO-DATE       TO L1640-INTERNAL-DATE.
           PERFORM  1640-2000-INTERNAL-TO-EXT
               THRU 1640-2000-INTERNAL-TO-EXT-X.
           IF  L1640-VALID
           ...
           MOVE R1100-ADJUSTED-DATE      TO L1640-INTERNAL-DATE.
           PERFORM  1640-2000-INTERNAL-TO-EXT
               THRU 1640-2000-INTERNAL-TO-EXT-X.
           IF  L1640-VALID
           ...
           MOVE R1100-MODX               TO P-MODX.
008455*    MOVE R1100-MODE-PREMIUM       TO P-MODE-PREMIUM.
 
008455*    MOVE R1100-DUE-F              TO P-DUE-1ST.
008455***** OUTPUT FORMAT : Z,ZZZ,ZZZ,ZZZ,ZZ9.99
008455     COMPUTE L0290-INPUT-NUMBER = 
017150*              R1100-DUE-F *  100
017150               R1100-DUE-F *  L0290-CRCY-MULT-FCT
...
008455*    MOVE R1100-DUE-R              TO P-DUE-REN.
008455***** OUTPUT FORMAT : Z,ZZZ,ZZZ,ZZZ,ZZ9.99
008455     COMPUTE L0290-INPUT-NUMBER = 
017150*              R1100-DUE-R *  100
017150               R1100-DUE-R *  L0290-CRCY-MULT-FCT
017150*    MOVE 2                     TO L0290-PRECISION
017150     MOVE WGLOB-CRCY-SCALE-QTY  TO L0290-PRECISION
...
008455*    MOVE R1100-ADV-F              TO P-ADV-1ST.
008455***** OUTPUT FORMAT : Z,ZZZ,ZZZ,ZZZ,ZZ9.99
008455     COMPUTE L0290-INPUT-NUMBER = 
017150*              R1100-ADV-F *  100
017150               R1100-ADV-F *  L0290-CRCY-MULT-FCT
017150*    MOVE 2                     TO L0290-PRECISION
017150     MOVE WGLOB-CRCY-SCALE-QTY  TO L0290-PRECISION
...
008455*    MOVE R1100-ADV-R              TO P-ADV-REN.
008455***** OUTPUT FORMAT : Z,ZZZ,ZZZ,ZZZ,ZZ9.99
008455     COMPUTE L0290-INPUT-NUMBER = 
017150*              R1100-ADV-R *  100
017150               R1100-ADV-R *  L0290-CRCY-MULT-FCT
017150*    MOVE 2                     TO L0290-PRECISION
017150     MOVE WGLOB-CRCY-SCALE-QTY  TO L0290-PRECISION
...
007684     MOVE SPACES                 TO RPRT1-SEQ-REC-INFO.
      ...
      *----------------------
           ...
           ADD R1100-DUE-F             TO TOTAL-PREM-DUE-1ST (1).
           ADD R1100-DUE-R             TO TOTAL-PREM-DUE-REN (1).
           ADD R1100-ADV-F             TO TOTAL-PREM-ADV-1ST (1).
           ADD R1100-ADV-R             TO TOTAL-PREM-ADV-REN (1).
           ADD R1100-DUE-F R1100-DUE-R TO TOTAL-NET (1).
           SUBTRACT R1100-ADV-F R1100-ADV-R FROM TOTAL-NET (1).
...
007684     MOVE P-STATEMENT-LINE   TO RPRT1-SEQ-REC-INFO.
      ...
      *---------------------------
           ...
           MOVE R1100-LOB            TO PH2-LOB.
           MOVE R1100-PAR            TO PH2-PAR.
