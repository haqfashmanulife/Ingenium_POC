...
015550**  14MAR2019 CTS    INITIAL REVISION                          **
      ...
      *************************
       COPY XCWWPGWS REPLACING '$VAR1' BY 'ZSBMUSDS'.
      ...
      /
       ...
       01  WS-931A-OLD-SEQ-REC-INFO.  
           ...
           05  WS-931A-ETC-WL-RESP-IND            PIC X(02).                                                                    
           05  WS-931A-ETC-MEDIC-RESP-IND         PIC X(02).                           
           05  WS-931A-ETC-CANCER-RESP-IND        PIC X(02).                            
