      ...
      **            IN THE L0220- PARM AREA.  IN ADDITION, IF AN     **
...
53-062 COPY XCWWPGWS REPLACING '$VAR1' BY 'XSRU0220'.
      /
       COPY SQLCA.
...
012624*        MOVE RUSEC-SECUR-CLAS-ID        TO WASCL-SECUR-CLAS-ID
...
54-001     SET L0220-USER-OK                   TO TRUE.
