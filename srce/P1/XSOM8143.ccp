      ...
      **                                                             **
      ** 15DEC99   60     NEW FOR INGENIUM 6.0                       **
014590**  15DEC99  60     ARCHITECTURAL CHANGES                      **
      ...
      ***************
       ...
       COPY XCWWPGWS REPLACING '$VAR1' BY 'XSOM8143'.
...
014590*COPY XCWL0030.
      /
       01  WS-WORKING-STORAGE.
           05  WS-BUS-FCN-ID                    PIC X(04).
               88  WS-BUS-FCN-DELETE            VALUE '8143'.
      /
      *****************************************************************
      *  COMMON COPYBOOKS                                             *
      *****************************************************************
      ...
      *
           ...
           PERFORM  BPFL-1000-READ-FOR-UPDATE
               THRU BPFL-1000-READ-FOR-UPDATE-X.
      ...
      *
           PERFORM  BPFL-1000-DELETE
               THRU BPFL-1000-DELETE-X.
