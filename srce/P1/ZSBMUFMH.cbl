...
015550**  14MAR2019 CTS    INITIAL REVISION                          **
      ...
      *************************
       COPY XCWWPGWS REPLACING '$VAR1' BY 'ZSBMUFMH'.
      ...
      /
       ...
       01  WS-931A-OLD-SEQ-REC-INFO.  
           ...
           05  WS-931A-MED-ADMIN-NM               PIC X(16).                     
           05  WS-931A-MED-ADMIN-SEX-CD           PIC X(02).                         
           05  WS-931A-MED-ADMIN-EMPRR-CD         PIC X(03).                           
           05  WS-931A-MED-ADMIN-BTH-DT           PIC X(06).                         
           05  WS-931A-MED-EXAM-DT1               PIC X(06).              
           05  WS-931A-MED-XRAY-IND               PIC X(02).                     
           05  WS-931A-MED-XRAY-INFO-IND          PIC X(02).                          
           05  WS-931A-MED-BLOOD-TST-IND          PIC X(02).                                                                      
           05  WS-931A-MED-MAX-BLOOD-RT           PIC X(03).                         
           05  WS-931A-MED-MIN-BLOOD-RT           PIC X(03).                         
           05  WS-931A-MED-ANEM-TST-IND           PIC X(02).                         
           05  WS-931A-MED-ANEM-HMGLB-QTY         PIC X(02).                           
           05  WS-931A-MED-LIVR-TST-IND           PIC X(02).                                                                     
           05  WS-931A-MED-LIVR-GOT-QTY           PIC X(03).                         
           05  WS-931A-MED-LIVR-GTP-QTY           PIC X(03).                                                                     
           05  WS-931A-MED-LIVR-GGTP-QTY          PIC X(03).                          
           05  WS-931A-LIPID-TST-IND              PIC X(02).                      
           05  WS-931A-LIPID-TC-QTY               PIC X(03).                     
           05  WS-931A-LIPID-HDL-QTY              PIC X(03).                      
           05  WS-931A-LIPID-LDL-QTY              PIC X(03).                      
           05  WS-931A-LIPID-TG-QTY               PIC X(03).                     
           05  WS-931A-BLOOD-SUGR-TST-IND         PIC X(02).                           
           05  WS-931A-BLOOD-SUGR-FBS-QTY         PIC X(03).                           
           05  WS-931A-BLOOD-HBA1C-QTY            PIC X(03).                        
           05  WS-931A-BLOOD-HBA1C-IND            PIC X(02).                        
           05  WS-931A-MED-URIN-TST-IND           PIC X(02).                         
           05  WS-931A-MED-URIN-PROTN-NUM         PIC X(06).                           
           05  WS-931A-MED-URIN-SUGR-NUM          PIC X(06).                                                                      
           05  WS-931A-MED-ALCHL-IND              PIC X(02).                      
           05  WS-931A-MED-EKG-IND                PIC X(02).                    
           05  WS-931A-MED-EKG-INFO-IND           PIC X(02).                         
           05  WS-931A-MED-CERT-DT1               PIC X(06).              
           05  WS-931A-STCKR-ID                   PIC X(11).                                                          
           05  WS-931A-SHT-2-ID                   PIC X(05).                 
           05  WS-931A-SELF-INSRD-KANA-NM         PIC X(16).                           
           05  WS-931A-SELF-EMPERR-CD             PIC X(03).
               88  WS-931A-SELF-EMPRR-TAISHO      VALUE '100'.
               88  WS-931A-SELF-EMPRR-SHOWA       VALUE '020'.
               88  WS-931A-SELF-EMPRR-HEISEI      VALUE '003'.
               88  WS-931A-SELF-EMPRR-KAIGEN      VALUE '004'.
           05  WS-931A-SELF-BTH-DT                PIC X(06).                    
           05  WS-931A-SELF-INSRD-SEX-CD          PIC X(02).                          
           05  WS-931A-SELF-DSCLSRE-DT            PIC X(06).              
           05  WS-931A-SELF-PROF-CD               PIC X(02).                     
           05  WS-931A-CLI-HT                     PIC X(03).               
           05  WS-931A-CLI-WGT                    PIC X(03).                                                            
           05  WS-931A-CLI-SMK-CIG-IND            PIC X(02).                        
           05  WS-931A-CLI-SMK-CIG-QTY            PIC X(03).                                                                    
           ...
           05  WS-931A-MED-CERT-DT                PIC X(08).                    
      ...
      * UPDATE MEDICAL EXAM DATE USING EMPEROR DATE CONVERSION UTILITY
               ...
               END-IF.
      * UPDATE MEDICAL CERTIFICATION DATE USING EMPEROR DATE CONVERSION UTILITY
               MOVE WS-931A-MED-CERT-DT1
                                            TO WS-DT
               MOVE WS-YY                   TO L9680-EMP-YY
               MOVE WS-MM                   TO L9680-EMP-MM
               MOVE WS-DD                   TO L9680-EMP-DD
               ...
               ELSE
                   ...
                   MOVE WS-931A-MM          TO WS-NEW-931A-MM
                   MOVE WS-931A-DD          TO WS-NEW-931A-DD
                   MOVE WS-NEW-931A-DT      TO WS-931A-MED-CERT-DT
               END-IF.
